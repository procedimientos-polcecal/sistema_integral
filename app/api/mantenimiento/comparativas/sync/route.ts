...
import { sincronizarComparativas } from "@/lib/mantenimiento/sincronizar";

export const maxDuration = 300;

/**
 * Trae las comparativas de su planilla, a pedido de alguien.
 *
...
export async function POST() {
  ...
  const r = await sincronizarComparativas();
