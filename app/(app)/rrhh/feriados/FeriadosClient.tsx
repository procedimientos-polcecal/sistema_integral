...
export default function FeriadosClient() {
  ...
  return (
    <div>
      <h1 className="text-xl font-bold text-slate-900 mb-4">Feriados</h1>
      <div className="card p-5 max-w-xl">
        ...
        {!feriados ? (
          <p className="text-slate-500 text-sm mb-3">Cargando...</p>
        ) : (
          <ul className="text-sm mb-3 space-y-1 max-h-64 overflow-auto">
            ...
            {feriados.length === 0 && <li className="text-slate-400">Todavía no hay feriados cargados</li>}
          </ul>
        )}
