...
export default function TurnosClient() {
  ...
  return (
    <div>
      <h1 className="text-xl font-bold text-slate-900 mb-4">Turnos</h1>
          ...
          {!jornadas ? (
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                {jornadas.length === 0 && (
                  <tr><td colSpan={4} className="py-4 text-center text-slate-400">Todavía no hay turnos definidos</td></tr>
                )}
              </tbody>
            </table>
            </div>
