  ...
  return (
    <div className="space-y-3">
      ...
      {!cargando && ordenes.length === 0 ? (
        ...
        <ol className="divide-y divide-slate-100 overflow-hidden card">
          {ordenes.map((o, i) => (
            <li
              key={o.id}
              ...
              className={`flex items-center gap-3 px-3 py-2.5 ${
                arrastrando === i ? "bg-slate-100 opacity-50" : "hover:bg-slate-50"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm text-slate-900">
                  <span className="font-mono text-xs text-slate-400">#{o.ot_number}</span>{" "}
              ...
              {puedeEditar && (
                <div className="flex shrink-0 flex-col">
                  <button
                    ...
                    className="px-1 text-xs leading-none text-slate-400 hover:text-slate-800 disabled:opacity-25"
                    title="Subir"
                  >▲</button>
                  <button
                    onClick={() => mover(i, i + 1)}
