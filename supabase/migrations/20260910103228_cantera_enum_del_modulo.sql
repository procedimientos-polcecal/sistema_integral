-- ============================================================
-- SdG — El módulo Cantera entra al enum
--
...
-- new value of enum type"). Cualquier función o policy que mencione 'cantera'
-- —incluso en el cuerpo, que se valida al crearla— tiene que ir en un archivo
-- posterior, ya commiteado este.
--
...
-- 20260908104728 (despacho), 20260910080302 (facturación).
-- ============================================================
